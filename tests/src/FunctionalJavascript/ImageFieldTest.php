...
class ImageFieldTest extends EntityBrowserWebDriverTestBase {
  ...
  public function testImageFieldUsage() {
    ...
    $this->assertSession()->elementExists('xpath', '//*[@data-drupal-selector="edit-field-image-current-0-display"]');
  ...
  public function testDragAndDropAndRemove() {
    ...
    // Test that remove with duplicate items removes the one at the correct delta.
    // If you remove file 1 at position 3, it should remove that one, not the
    // same entity at position 1.
    $values = [
      ['target_id' => 2],
      ['target_id' => 3],
      ['target_id' => 2],
